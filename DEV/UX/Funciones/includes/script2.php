...
//    -------------------Fee Mensual aplicacion --------------- 
   ...
   var FeeMenApp_SOR = ((($("#CantEmpAct_SOR").val())*FeePorEmp_SOR)-($("#PerConServ_SOR").val())*(($("#CantEmpAct_SOR").val())*FeePorEmp_SOR)*DescPorAno)*valor;
   ...
   if (FeeMenApp_SOR <=1983.33 && FeeMenApp_SOR >=150) {
       ...
       FeeMenApp_SOR=1983.33*valor;
       var feemensualsor = FeeMenApp_SOR.toFixed(0);
       $("#FeeMenApp_SOR").text("$"+formatMoney(feemensualsor)); 
   }else{
        FeeMenApp_SOR=150*valor;
       var feemensualsor = FeeMenApp_SOR.toFixed(0);
       $("#FeeMenApp_SOR").text("$"+formatMoney(feemensualsor)); 
   }
...
//    -------------------Fee Mensual aplicacion --------------- 
   var FeeMenApp_SER = (((($("#CantEmpAct_SER").val())*FeePorEmp_SER)-($("#PerConServ_SER").val())*(($("#CantEmpAct_SER").val())*FeePorEmp_SER)*DescPorAno)*0.35)*valor;
   
   if (FeeMenApp_SER<=654.50 && FeeMenApp_SER >=100) {
       $("#FeeMenApp_SER").text("$"+FeeMenApp_SER.toFixed(0)); 
   } else if (FeeMenApp_SER > 654.50){
       FeeMenApp_SER=654.50 * valor;
       $("#FeeMenApp_SER").text("$"+FeeMenApp_SER.toFixed(0)); 
   }else{
    FeeMenApp_SER=100 * valor;
       $("#FeeMenApp_SER").text("$"+FeeMenApp_SER.toFixed(0)); 
   }
...
$( "#PerConServ_SIP" ).change(function() {
   ...
   //    -------------------Fee Mensual aplicacion --------------- 
   var FeeMenApp_SIP = (((($("#CantEmpAct_SIP").val())*FeePorEmp_SER)-($("#PerConServ_SIP").val())*(($("#CantEmpAct_SIP").val())*FeePorEmp_SER)*DescPorAno)*0.35)*valor;

   if (FeeMenApp_SIP<=654.50 && FeeMenApp_SIP >=100) {
       $("#FeeMenApp_SIP").text("$"+FeeMenApp_SIP.toFixed(0)); 
   } else if (FeeMenApp_SIP > 654.50){
       FeeMenApp_SIP=654.50*valor;
       $("#FeeMenApp_SIP").text("$"+FeeMenApp_SIP.toFixed(0)); 
   }else{
    FeeMenApp_SIP=100*valor;
       $("#FeeMenApp_SIP").text("$"+FeeMenApp_SIP.toFixed(0)); 
   }
...
//    -------------------Fee Mensual aplicacion --------------- 
   var FeeMenApp_SEP = (((($("#CantEmpAct_SEP").val())*FeePorEmp_SER)-($("#PerConServ_SEP").val())*(($("#CantEmpAct_SEP").val())*FeePorEmp_SER)*DescPorAno)*0.35)*valor;
 
   if (FeeMenApp_SEP<=654.50 && FeeMenApp_SEP >=100) {
       $("#FeeMenApp_SEP").text("$"+FeeMenApp_SEP.toFixed(0)); 
   } else if (FeeMenApp_SEP > 654.50){
       FeeMenApp_SEP=654.50*valor;
       $("#FeeMenApp_SEP").text("$"+FeeMenApp_SEP.toFixed(0)); 
   }else{
    FeeMenApp_SEP=100*valor;
       $("#FeeMenApp_SEP").text("$"+FeeMenApp_SEP.toFixed(0)); 
   }
...
//    -------------------Fee Mensual aplicacion --------------- 
   var FeeMenApp_SEA = (((($("#CantEmpAct_SEA").val())*FeePorEmp_SER)-(($("#CantEmpAct_SEA").val())*FeePorEmp_SER)*DescPorAno)*0.3)*valor;
...
//    -------------------Fee Mensual aplicacion --------------- 
   var FeeMenApp_SES = (((($("#CantEmpAct_SES").val())*FeePorEmp_SER)-(($("#CantEmpAct_SES").val())*FeePorEmp_SER)*DescPorAno)*0.3)*valor;
...
/**     -------------------Fee Implementacion unico y mensual solo de las primeras 4 apps--------------- */
   var FeeImplePM_SOR = (((4900)/12)*valor).toFixed(2);
   $("#FeeImplePM_SOR").text("$"+FeeImplePM_SOR); 

   var FeeImplePM_SER = (((2150)/12)*valor).toFixed(2);
   $("#FeeImplePM_SER").text("$"+FeeImplePM_SER); 

   var FeeImplePM_SIP = (((2150)/12)*valor).toFixed(2);
   $("#FeeImplePM_SIP").text("$"+FeeImplePM_SIP); 

   var FeeImplePM_SEP = (((2150)/12)*valor).toFixed(2);
