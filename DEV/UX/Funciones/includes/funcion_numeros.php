...
switch ($longitud) { 
    ...
    $resto = ltrim(substr($numero,1), "0"); //Substrae lo que esta a la derecha del "mil" P.Ejm 13001;Res=24
        break;
    case $longitud==5:
...
//**-------------------------------------------------- Impresion ------------------------------*/
if($numero>1000 && $numero<1000000 ){ //Si el numero ingresado es mayor que mil y menor que un millon entonces imprime
    return $arreglo_numeros[$miles]." mil ".$arreglo_numeros[$resto];
}
else if ($numero==1000){  //Si el numero ingresado es igual que mil imprime
    return "un mil";
}
else if($numero<1000 && $numero >= 0){
    return $arreglo_numeros[$numero]; //Si el numero ingresado es menor que mil y mayor o igual que 0 imprime
}
else {
