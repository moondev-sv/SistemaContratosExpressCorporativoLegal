...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
        ...
        <img src="/CL/DEV/UI/assets/logo2.png" style="width:100%;z-index:-1;" alt=""> 
        <div style="text-align:left;margin-top:2px;margin-left:5%;">
            ...
            <a href="?x=ver_contratos.php" class="w3-bar-item w3-button btn">Ver Contratos Digitados</a></div>
            <!--<a href="?x=p_migrato_1p.php" class="w3-bar-item w3-button btn">Permiso migratorio: p/viajar con 1 de los padres</a>-->
       <hr>
        <div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 offset-sm-0">
                                    ...
                                    if (isset($_GET['x'])) {
                                        ...
                                        echo "<h2 id='bienvenida' class='display-5' style='color:black!important;'>Bienvenido al panel de administracion</h2>";
                                    }
                                    ?>
                                    <script>
                                    function w3_open() {
